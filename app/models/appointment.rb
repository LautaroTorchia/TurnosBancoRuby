class Appointment < ApplicationRecord
  ...
  validates_presence_of :date, message: 'La fecha no puede estar vacia' 
  validates_presence_of :motive, message: 'El motivo no puede estar vacio' 
  validates_presence_of :status, message: 'El estado no puede estar vacio' 
